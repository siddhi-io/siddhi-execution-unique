...
### ever *<a target="_blank" href="http://siddhi.io/en/v5.0/docs/query-guide/#window">(Window)</a>*
<p style="word-wrap: break-word">Window that retains the latest events based on a given unique key. When a new event arrives with the same key it replaces the one exist in the window.</p>
...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">The attribute used to checked for uniqueness. If multiple attributes need to be checked, they can be specified as a comma-separated list.</td>
...
### first *<a target="_blank" href="http://siddhi.io/en/v5.0/docs/query-guide/#window">(Window)</a>*
...
### firstLengthBatch *<a target="_blank" href="http://siddhi.io/en/v5.0/docs/query-guide/#window">(Window)</a>*
...
### firstTimeBatch *<a target="_blank" href="http://siddhi.io/en/v5.0/docs/query-guide/#window">(Window)</a>*
...
### timeLengthBatch *<a target="_blank" href="http://siddhi.io/en/v5.0/docs/query-guide/#window">(Window)</a>*
